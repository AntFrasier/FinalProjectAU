...
const Index = () => {
    ...
    return (
      <Flex flexDir={"column"} alignContent={"flex-start"} justifyContent={"center"} alignItems={"flex-start"} marginInline={"auto"} paddingInline={15} maxW={"1080px"}>
        ...
        <Heading as={"h2"} marginBottom={15}>Bring loyalty to Blockchain</Heading>
        <Text>
          Welcome to loyaltEth! This Dapp has been created for my final Alchemy Project.
        </Text>
        <Text>
          This is a proof of concept more than a protype. It's Uggly, and needs to be moretested and improve ! It'sd open source, you can find the code  <Link color="blue" href="https://twitter.com/MaranberC" target="_blank" rel='noreferrer nofollow noopener'> here </Link>
        </Text>
        ...
        <Heading fontSize={"2rem "}as={"h3"}>As a Partner</Heading>
        ...
        <Heading fontSize={"2rem "}as={"h3"}>As a User</Heading>
        ...
        <Text>
          If you have any question, or want to work on that project and push it forward, please HMU on  <Link color="blue" href="https://twitter.com/MaranberC" target="_blank" rel='noreferrer nofollow noopener'>tweeter</Link> or on my <Link color="blue" href="https://cyril-maranber.com/contacts/" target="_blank">personal website</Link>.
        </Text>
      </Flex>
    )
}
